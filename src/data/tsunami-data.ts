...
export function getVerdict(score: number): { emoji: string; title: string; description: string } {
  ...
  if (score >= 90) {
    return {
      emoji: '🏄',
      title: 'Wave Rider',
      description: 'AI-native, commanding the storm',
    };
  }
  if (score >= 80) {
    return {
...
export const TIER_INFO: TierInfo[] = [
  ...
  { tier: 3, name: 'Hybrid Cruiser', emoji: '⚡', description: 'Tech-augmented vessel — chrome plating, circuit lines, radar arrays', scoreRange: '80–89' },
  { tier: 4, name: 'AI Flagship', emoji: '✦', description: 'AI-native command ship — geometric intelligence above the storm', scoreRange: '90–94' },
  { tier: 5, name: 'The Singularity', emoji: '🔱', description: 'Beyond comprehension — reshapes reality itself, master of ocean and sky', scoreRange: '95–100' },
];
